...
class Subtitle(object):
	...
	def __init__(self, movie_file_number, subtitles_path, new_dialog_secs):
		""" Inicia la clase, lee el archivo .srt y lo parsea """
		self.movie_file_number = str(movie_file_number)
		self.file_path = self.file_name(subtitles_path)
		...
		self.dialogs_list = self.dialogs(self.pysrt, new_dialog_secs)
